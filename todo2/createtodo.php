...
<form method="post" action="createtodoc.php">
  <div class="createtodo">
    <label for="Titel">Titel</label> 
    <input id="Titel" name="Titel" placeholder="Titel eingeben!" type="text" required="required" class="form-control">
  </div>
<!-- kategorien mit id als value-->
...
<select name="prio" id="prio">
  ...
  <div class="form-group">
    ...
    <textarea id="info" name="info" cols="40" rows="5" class="form-control" required="required"></textarea>
</div>
<input class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" pattern="\d{4}-\d{1,2}-\d{1,2}" value="<?php echo $zeile[3]; ?>" name="date_end">
<script>
...
<!--- <script type="text/javascript">
        $(function() {
            $('#datepicker').datepicker();
                ...
                <label for="date" class="col-sm-1 col-form-label">Ablaufdatum</label>
                <div class="col-sm-4">
